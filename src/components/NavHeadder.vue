<template>
  <nav class="home">
    ...
    <router-link  to="/iniciarsesion" v-if="token === ''">
      ...
      <a  v-if="token !== ''"  @click="cerrarSesion">
    ...
    <div id="publicarNuevaMascota"> <router-link to="/nuevamascota"> <a id="publicar">Publicar mascota</a></router-link></div>
  </nav>
</template>
